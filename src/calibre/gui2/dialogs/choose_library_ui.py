...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(I("document_open.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.location.setSizeAdjustPolicy(QtWidgets.QComboBox.SizeAdjustPolicy.AdjustToMinimumContentsLength)
