...
class Ui_TagCategories(object):
    def setupUi(self, TagCategories):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.category_box)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.category_filter_box)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_filt)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.item_filter_box)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(I("forward.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(I("minus.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
