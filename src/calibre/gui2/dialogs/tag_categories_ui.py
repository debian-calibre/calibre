...
class Ui_TagCategories(object):
    def setupUi(self, TagCategories):
        ...
        self.gridLayout_2.addWidget(self.available_items_box, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.applied_items_box, 2, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.unapply_button, 2, 3, 1, 1)
