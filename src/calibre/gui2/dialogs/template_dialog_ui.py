...
class Ui_TemplateDialog(object):
    def setupUi(self, TemplateDialog):
        ...
        self.gridLayout.addWidget(self.template_value, 6, 0, 1, 4)
        ...
        self.gridLayout.addLayout(self.gridlayout2, 22, 0, 1, 4)
    ...
    def retranslateUi(self, TemplateDialog):
        ...
        self.font_name_label.setText(_("Current font:"))
        ...
        self.label2.setText(_("Template Function Reference"))
        self.label3.setText(_("Function &name:"))
