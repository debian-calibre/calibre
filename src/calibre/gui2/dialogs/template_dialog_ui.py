...
class Ui_TemplateDialog(object):
    def setupUi(self, TemplateDialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(I("edit-copy.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.new_doc_label = QtWidgets.QLabel(TemplateDialog)
        ...
        self.new_doc = QtWidgets.QTextEdit(TemplateDialog)
        ...
        self.gridLayout.addLayout(self.gridLayout1, 6, 1, 1, 3)
        self.frame = QtWidgets.QFrame(TemplateDialog)
        self.frame.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.frame.setObjectName("frame")
        self.gridLayout.addWidget(self.frame, 7, 0, 1, 5)
        self.label3 = QtWidgets.QLabel(TemplateDialog)
        self.label3.setObjectName("label3")
        self.gridLayout.addWidget(self.label3, 8, 0, 1, 2)
        self.label4 = QtWidgets.QLabel(TemplateDialog)
        self.label4.setObjectName("label4")
        self.gridLayout.addWidget(self.label4, 9, 0, 1, 1)
        self.function = QtWidgets.QComboBox(TemplateDialog)
        self.function.setObjectName("function")
        self.gridLayout.addWidget(self.function, 9, 1, 1, 3)
        self.label_22 = QtWidgets.QLabel(TemplateDialog)
        ...
        self.func_type = QtWidgets.QLineEdit(TemplateDialog)
        self.func_type.setReadOnly(True)
        self.func_type.setObjectName("func_type")
        self.gridLayout.addWidget(self.func_type, 10, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.documentation, 11, 1, 1, 3)
        self.source_code = QtWidgets.QPlainTextEdit(TemplateDialog)
        self.source_code.setObjectName("source_code")
        self.gridLayout.addWidget(self.source_code, 12, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.template_tutorial, 13, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.template_func_reference, 14, 1, 1, 1)
