...
class Ui_MetadataBulkDialog(object):
    def setupUi(self, MetadataBulkDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 934, 661))
        ...
        MetadataBulkDialog.setTabOrder(self.comments_button, self.search_for)
        ...
        MetadataBulkDialog.setTabOrder(self.scrollArea11, self.refresh_book_list)
        MetadataBulkDialog.setTabOrder(self.refresh_book_list, self.save_button)
        MetadataBulkDialog.setTabOrder(self.save_button, self.search_field)
        MetadataBulkDialog.setTabOrder(self.search_field, self.multiple_separator)
        MetadataBulkDialog.setTabOrder(self.multiple_separator, self.query_field)
        MetadataBulkDialog.setTabOrder(self.query_field, self.test_result)
        MetadataBulkDialog.setTabOrder(self.test_result, self.scrollArea)
        MetadataBulkDialog.setTabOrder(self.scrollArea, self.remove_button)
        MetadataBulkDialog.setTabOrder(self.remove_button, self.search_mode)
        ...
        MetadataBulkDialog.setTabOrder(self.s_r_template, self.test_text)
        MetadataBulkDialog.setTabOrder(self.test_text, self.central_widget)
