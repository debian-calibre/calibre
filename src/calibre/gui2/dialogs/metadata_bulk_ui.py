...
class Ui_MetadataBulkDialog(object):
    def setupUi(self, MetadataBulkDialog):
        ...
        MetadataBulkDialog.resize(962, 669)
        icon = QtGui.QIcon()
        ...
        self.gridLayout.addLayout(self.horizontalLayout, 16, 0, 1, 3)
        ...
        self.remove_format = QtWidgets.QComboBox(self.tabWidgetPage1)
        self.remove_format.setMaximumSize(QtCore.QSize(120, 16777215))
        self.remove_format.setObjectName("remove_format")
        ...
        self.gridLayout.addLayout(self.horizontalLayout_3, 14, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.groupBox, 15, 0, 1, 3)
        ...
        self.HLayout_31.addItem(spacerItem7)
        ...
        self.verticalLayout1.addItem(spacerItem9)
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(0, 0, 210, 66))
