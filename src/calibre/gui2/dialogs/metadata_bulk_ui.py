...
class Ui_MetadataBulkDialog(object):
    def setupUi(self, MetadataBulkDialog):
        ...
        icon = QtGui.QIcon.ic("edit_input.png")
        ...
        icon1 = QtGui.QIcon.ic("chapters.png")
        ...
        icon2 = QtGui.QIcon.ic("trash.png")
        ...
        spacerItem = QtWidgets.QSpacerItem(17, 13, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        ...
        spacerItem4 = QtWidgets.QSpacerItem(17, 17, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.vargrid.addWidget(self.xlabel_24, 4, 0, 1, 1)
        ...
        self.vargrid.addWidget(self.s_r_template, 6, 1, 1, 1)
        self.xlabel_2 = QtWidgets.QLabel(self.tabWidgetPage3)
        self.xlabel_2.setObjectName("xlabel_2")
        self.vargrid.addWidget(self.xlabel_2, 7, 0, 1, 1)
        ...
        self.vargrid.addWidget(self.search_for, 7, 1, 1, 1)
        ...
        self.vargrid.addLayout(self.verticalLayout, 8, 2, 1, 1)
        ...
        spacerItem9 = QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.verticalLayout_2.addItem(spacerItem9)
        self.vargrid.addLayout(self.verticalLayout_2, 9, 2, 1, 1)
        self.s_r_dst_ident_label = QtWidgets.QLabel(self.tabWidgetPage3)
        self.s_r_dst_ident_label.setObjectName("s_r_dst_ident_label")
        self.vargrid.addWidget(self.s_r_dst_ident_label, 10, 0, 1, 1)
        ...
        self.vargrid.addWidget(self.s_r_dst_ident, 10, 1, 1, 1)
        self.horizontalLayout_21 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_21.setObjectName("horizontalLayout_21")
        spacerItem10 = QtWidgets.QSpacerItem(20, 0, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.vargrid.addLayout(self.horizontalLayout_21, 11, 1, 1, 2)
        ...
        self.vargrid.addWidget(self.scrollArea11, 12, 0, 1, 4)
        ...
        self.button_box.accepted.connect(MetadataBulkDialog.accept) # type: ignore
        self.button_box.rejected.connect(MetadataBulkDialog.reject) # type: ignore
        ...
        MetadataBulkDialog.setTabOrder(self.search_mode, self.search_field)
        MetadataBulkDialog.setTabOrder(self.search_field, self.s_r_src_ident)
...
" e.g., EPUB to EPUB, calibre saves the original EPUB\n"
...
"as that of the first selected book."))
        ...
        self.search_mode.setToolTip(_("<p>Choose whether to use basic text matching or advanced\n"
