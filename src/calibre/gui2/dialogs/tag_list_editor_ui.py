...
class Ui_TagListEditor(object):
    def setupUi(self, TagListEditor):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(I("trash.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(I("edit-undo.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
