...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.opt_output_profile = QtWidgets.QListView(parent=Form)
        self.opt_output_profile.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.PreventContextMenu)
        ...
        self.profile_description = QtWidgets.QLabel(parent=self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(4)
        sizePolicy.setVerticalStretch(0)
        ...
        self.opt_input_profile = QtWidgets.QListView(parent=Form)
        self.opt_input_profile.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.PreventContextMenu)
        ...
        self.opt_margin_left = QtWidgets.QDoubleSpinBox(parent=self.groupBox_2)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_margin_left)
        self.label_4 = QtWidgets.QLabel(parent=self.groupBox_2)
        self.label_4.setObjectName("label_4")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_4)
        self.opt_margin_top = QtWidgets.QDoubleSpinBox(parent=self.groupBox_2)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_margin_top)
        self.label_5 = QtWidgets.QLabel(parent=self.groupBox_2)
        self.label_5.setObjectName("label_5")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_5)
        self.opt_margin_right = QtWidgets.QDoubleSpinBox(parent=self.groupBox_2)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_margin_right)
        self.label_6 = QtWidgets.QLabel(parent=self.groupBox_2)
        self.label_6.setObjectName("label_6")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_6)
        self.opt_margin_bottom = QtWidgets.QDoubleSpinBox(parent=self.groupBox_2)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_margin_bottom)
