...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.opt_comic_image_size.setClearButtonEnabled(True)
        ...
        self.opt_no_process.toggled['bool'].connect(self.label_3.setDisabled) # type: ignore
        self.opt_no_process.toggled['bool'].connect(self.opt_colors.setDisabled) # type: ignore
        self.opt_no_process.toggled['bool'].connect(self.opt_dont_normalize.setDisabled) # type: ignore
        self.opt_no_process.toggled['bool'].connect(self.opt_keep_aspect_ratio.setDisabled) # type: ignore
        self.opt_no_process.toggled['bool'].connect(self.opt_dont_sharpen.setDisabled) # type: ignore
        self.opt_no_process.toggled['bool'].connect(self.opt_disable_trim.setDisabled) # type: ignore
        self.opt_no_process.toggled['bool'].connect(self.opt_wide.setDisabled) # type: ignore
        self.opt_no_process.toggled['bool'].connect(self.opt_landscape.setDisabled) # type: ignore
        self.opt_no_process.toggled['bool'].connect(self.opt_right2left.setDisabled) # type: ignore
        self.opt_no_process.toggled['bool'].connect(self.opt_no_sort.setDisabled) # type: ignore
        self.opt_no_process.toggled['bool'].connect(self.opt_despeckle.setDisabled) # type: ignore
        self.opt_no_process.toggled['bool'].connect(self.opt_output_format.setDisabled) # type: ignore
        self.opt_no_process.toggled['bool'].connect(self.opt_dont_grayscale.setDisabled) # type: ignore
