...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.search_replace.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.SingleSelection)
        self.search_replace.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
