...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_base_font_size)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_minimum_line_height)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_line_height)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_embed_font_family)
        self.opt_embed_all_fonts = QtWidgets.QCheckBox(self.tab1)
        self.opt_embed_all_fonts.setObjectName("opt_embed_all_fonts")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_embed_all_fonts)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.LabelRole, self.opt_subset_embedded_fonts)
        self.opt_expand_css = QtWidgets.QCheckBox(self.tab1)
        self.opt_expand_css.setObjectName("opt_expand_css")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.ItemRole.LabelRole, self.opt_expand_css)
        self.opt_keep_ligatures = QtWidgets.QCheckBox(self.tab1)
        self.opt_keep_ligatures.setObjectName("opt_keep_ligatures")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.ItemRole.LabelRole, self.opt_keep_ligatures)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_disable_font_rescaling)
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_input_encoding)
        ...
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_change_justification)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_smarten_punctuation)
        ...
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_unsmarten_punctuation)
        self.opt_asciiize = QtWidgets.QCheckBox(self.tab)
        self.opt_asciiize.setObjectName("opt_asciiize")
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_asciiize)
        ...
        self.filter_css_others.setClearButtonEnabled(True)
        ...
        self.verticalLayout_2.addWidget(self.opt_transform_html_rules)
        self.MainTabs.addTab(self.tab_5, "")
        self.horizontalLayout_2.addWidget(self.MainTabs)
        ...
        self.opt_disable_font_rescaling.toggled['bool'].connect(self.opt_base_font_size.setDisabled) # type: ignore
        self.opt_disable_font_rescaling.toggled['bool'].connect(self.opt_font_size_mapping.setDisabled) # type: ignore
        self.opt_remove_paragraph_spacing.toggled['bool'].connect(self.label_4.setEnabled) # type: ignore
        self.opt_remove_paragraph_spacing.toggled['bool'].connect(self.opt_remove_paragraph_spacing_indent_size.setEnabled) # type: ignore
    ...
    def retranslateUi(self, Form):
        ...
        self.MainTabs.setTabText(self.MainTabs.indexOf(self.tab_5), _("Transform &HTML"))
from calibre.gui2.css_transform_rules import RulesWidget
from calibre.gui2.font_family_chooser import FontFamilyChooser
from calibre.gui2.html_transform_rules import HtmlRulesWidget
