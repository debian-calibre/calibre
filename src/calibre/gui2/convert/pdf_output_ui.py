...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.SpanningRole, self.label_10)
        self.opt_override_profile_size = QtWidgets.QCheckBox(Form)
        self.opt_override_profile_size.setObjectName("opt_override_profile_size")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.opt_override_profile_size)
        self.label = QtWidgets.QLabel(Form)
        self.label.setObjectName("label")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label)
        self.opt_paper_size = QtWidgets.QComboBox(Form)
        self.opt_paper_size.setObjectName("opt_paper_size")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.opt_paper_size)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.SpanningRole, self.opt_preserve_cover_aspect_ratio)
        self.opt_pdf_page_numbers = QtWidgets.QCheckBox(Form)
        self.opt_pdf_page_numbers.setObjectName("opt_pdf_page_numbers")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.SpanningRole, self.opt_pdf_page_numbers)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_10.setText(_("<b>Note:</b> The paper size settings below only take effect if you enable the \"Override\" checkbox below. Otherwise the size from the output profile will be used."))
        self.opt_override_profile_size.setText(_("&Override paper size set in output profile"))
