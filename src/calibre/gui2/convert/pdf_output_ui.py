...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_pdf_page_numbers)
        self.opt_pdf_add_toc = QtWidgets.QCheckBox(Form)
        self.opt_pdf_add_toc.setObjectName("opt_pdf_add_toc")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_pdf_add_toc)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_toc_title)
        self.label_4 = QtWidgets.QLabel(Form)
        self.label_4.setObjectName("label_4")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_4)
        self.opt_pdf_serif_family = QtWidgets.QFontComboBox(Form)
        self.opt_pdf_serif_family.setObjectName("opt_pdf_serif_family")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_pdf_serif_family)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_pdf_sans_family)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_pdf_mono_family)
        self.label_7 = QtWidgets.QLabel(Form)
        self.label_7.setObjectName("label_7")
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_7)
        self.opt_pdf_standard_font = QtWidgets.QComboBox(Form)
        self.opt_pdf_standard_font.setObjectName("opt_pdf_standard_font")
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_pdf_standard_font)
        ...
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_pdf_default_font_size)
        self.label_9 = QtWidgets.QLabel(Form)
        self.label_9.setObjectName("label_9")
        self.formLayout.setWidget(15, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_9)
        self.opt_pdf_mono_font_size = QtWidgets.QSpinBox(Form)
        self.opt_pdf_mono_font_size.setObjectName("opt_pdf_mono_font_size")
        self.formLayout.setWidget(15, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_pdf_mono_font_size)
        self.label_91 = QtWidgets.QLabel(Form)
        self.label_91.setObjectName("label_91")
        self.formLayout.setWidget(16, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_91)
        ...
        self.formLayout.setWidget(16, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_pdf_page_number_map)
        self.page_margins_box = QtWidgets.QGroupBox(Form)
        self.page_margins_box.setObjectName("page_margins_box")
        self.formLayout.setWidget(18, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.page_margins_box)
        ...
        self.formLayout.setWidget(19, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.template_box)
        self.opt_pdf_hyphenate = QtWidgets.QCheckBox(Form)
        self.opt_pdf_hyphenate.setObjectName("opt_pdf_hyphenate")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_pdf_hyphenate)
        self.label_2 = QtWidgets.QLabel(Form)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(17, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_2)
        ...
        self.formLayout.setWidget(17, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_pdf_odd_even_offset)
