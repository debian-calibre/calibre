...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(I("store.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.store_splitter.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(I("config.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.configure.setIcon(icon1)
        self.configure.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextBesideIcon)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(I("search.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
