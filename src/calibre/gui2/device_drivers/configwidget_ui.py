...
class Ui_ConfigWidget(object):
    def setupUi(self, ConfigWidget):
        ...
        self.columns.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(I("arrow-down.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
