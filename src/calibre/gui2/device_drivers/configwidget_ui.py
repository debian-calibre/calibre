...
class Ui_ConfigWidget(object):
    ...
    def retranslateUi(self, ConfigWidget):
        ...
        self.opt_use_subdirs.setToolTip(_("If checked, books are placed into sub-folders based on their metadata on the device. If unchecked, books are all put into the top level folder."))
        self.opt_use_subdirs.setText(_("Use sub-folders"))
