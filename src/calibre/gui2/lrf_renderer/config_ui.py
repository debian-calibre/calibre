...
class Ui_ViewerConfig(object):
    def setupUi(self, ViewerConfig):
        ...
        icon = QtGui.QIcon.ic("config.png")
        ...
        self.buttonBox.accepted.connect(ViewerConfig.accept) # type: ignore
        self.buttonBox.rejected.connect(ViewerConfig.reject) # type: ignore
