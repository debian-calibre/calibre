...
class Ui_WizardPage(object):
    ...
    def retranslateUi(self, WizardPage):
        ...
        self.label.setText(_("<p>If you use the <a href=\"http://www.lexcycle.com/download\">Stanza</a> or <a href=\"http://marvinapp.com/\">Marvin</a> e-book reading app on your Apple iDevice, you can access your calibre book collection wirelessly, directly on the device. To do this you have to turn on the calibre content server."))
