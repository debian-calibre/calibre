...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.regex_results_label.setTextFormat(QtCore.Qt.TextFormat.AutoText)
        self.regex_results_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.exclude_genre_results.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.exclude_genre_results.setText("")
        self.exclude_genre_results.setTextFormat(QtCore.Qt.TextFormat.PlainText)
