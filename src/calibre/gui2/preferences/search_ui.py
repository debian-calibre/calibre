...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.clear_history_button = QtWidgets.QPushButton(parent=self.tab)
        ...
        self.gridLayout_6.addWidget(self.clear_history_button, 11, 0, 1, 1)
        ...
        self.opt_limit_search_columns = QtWidgets.QCheckBox(parent=self.groupBox)
        ...
        self.opt_limit_search_columns_to = EditWithComplete(parent=self.groupBox)
        ...
        self.gridLayout_6.addWidget(self.groupBox, 10, 0, 1, 2)
        self.opt_search_as_you_type = QtWidgets.QCheckBox(parent=self.tab)
        ...
        self.opt_case_sensitive = QtWidgets.QCheckBox(parent=self.tab)
        self.opt_case_sensitive.setObjectName("opt_case_sensitive")
        self.gridLayout_6.addWidget(self.opt_case_sensitive, 3, 0, 1, 1)
        self.opt_highlight_search_matches = QtWidgets.QCheckBox(parent=self.tab)
        ...
        self.opt_show_highlight_toggle_button = QtWidgets.QCheckBox(parent=self.tab)
        ...
        self.gridLayout_6.addItem(spacerItem, 20, 0, 1, 1)
        self.opt_use_primary_find_in_search = QtWidgets.QCheckBox(parent=self.tab)
        ...
        self.opt_search_tool_bar_shows_text = QtWidgets.QCheckBox(parent=self.tab)
        ...
        self.opt_saved_search_menu_is_hierarchical = QtWidgets.QCheckBox(parent=self.tab)
        ...
        self.opt_allow_keyboard_search_in_library_views = QtWidgets.QCheckBox(parent=self.tab)
        self.opt_allow_keyboard_search_in_library_views.setObjectName("opt_allow_keyboard_search_in_library_views")
        self.gridLayout_6.addWidget(self.opt_allow_keyboard_search_in_library_views, 7, 0, 1, 1)
        ...
        self.la10 = QtWidgets.QLabel(parent=self.groupBox_2)
        self.la10.setObjectName("la10")
        self.l12.addWidget(self.la10, 0, 0, 1, 1)
        self.gst_names = QtWidgets.QComboBox(parent=self.groupBox_2)
        ...
        self.gst_delete_button = QtWidgets.QToolButton(parent=self.groupBox_2)
        icon = QtGui.QIcon.ic("trash.png")
        ...
        self.la112 = QtWidgets.QLabel(parent=self.groupBox_2)
        self.la112.setObjectName("la112")
        self.l12.addWidget(self.la112, 1, 0, 1, 1)
        self.gst_value = EditWithComplete(parent=self.groupBox_2)
        self.gst_value.setObjectName("gst_value")
        self.l12.addWidget(self.gst_value, 1, 1, 1, 1)
        self.hboxlayout = QtWidgets.QHBoxLayout()
        self.hboxlayout.setObjectName("hboxlayout")
        self.gst_save_button = QtWidgets.QToolButton(parent=self.groupBox_2)
        ...
        self.gst_explanation = QtWidgets.QTextBrowser(parent=self.groupBox_2)
        ...
        self.l11 = QtWidgets.QLabel(parent=self.groupBox_2)
        self.l11.setObjectName("l11")
        self.user_category_layout.addWidget(self.l11)
        self.opt_grouped_search_make_user_categories = EditWithComplete(parent=self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.opt_similar_authors_match_kind = QtWidgets.QComboBox(parent=self.groupBox22)
        ...
        self.label_222 = QtWidgets.QLabel(parent=self.groupBox22)
        self.label_222.setObjectName("label_222")
        self.gridLayout_22.addWidget(self.label_222, 1, 3, 1, 1)
        self.similar_series_search_key = QtWidgets.QComboBox(parent=self.groupBox22)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(10)
        sizePolicy.setVerticalStretch(0)
        ...
        self.opt_similar_series_match_kind = QtWidgets.QComboBox(parent=self.groupBox22)
        ...
        self.label_223 = QtWidgets.QLabel(parent=self.groupBox22)
        self.label_223.setObjectName("label_223")
        self.gridLayout_22.addWidget(self.label_223, 2, 0, 1, 1)
        self.similar_tags_search_key = QtWidgets.QComboBox(parent=self.groupBox22)
        ...
        self.opt_similar_tags_match_kind = QtWidgets.QComboBox(parent=self.groupBox22)
        ...
        self.label_224 = QtWidgets.QLabel(parent=self.groupBox22)
        self.label_224.setObjectName("label_224")
        self.gridLayout_22.addWidget(self.label_224, 2, 3, 1, 1)
        self.similar_publisher_search_key = QtWidgets.QComboBox(parent=self.groupBox22)
        ...
        self.opt_similar_publisher_match_kind = QtWidgets.QComboBox(parent=self.groupBox22)
...
"                  Hierarchy and searching</p>"))
        self.opt_allow_keyboard_search_in_library_views.setText(_("Use keyboard searching in the book list"))
        self.opt_allow_keyboard_search_in_library_views.setToolTip(_("<p>If enabled then pressing a key in the library view\n"
