...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.opt_allow_keyboard_search_in_library_views = QtWidgets.QCheckBox(self.tab)
...
"                  Hierarchy and searching</p>"))
        ...
        self.opt_allow_keyboard_search_in_library_views.setToolTip(_("<p>When enabled, pressing a key in the library view will search for the next cell in the current column where the value starts with the letter pressed. If there is no such cell then nothing happens. If the letter is a shortcut then the shortcut takes precedence.</p>"))
