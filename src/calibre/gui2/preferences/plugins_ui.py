...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QtGui.QIcon.ic("arrow-down.png")
        ...
        icon1 = QtGui.QIcon.ic("arrow-up.png")
        ...
        icon2 = QtGui.QIcon.ic("plugins/plugin_new.png")
        ...
        icon3 = QtGui.QIcon.ic("plugins/plugin_updater.png")
        ...
        icon4 = QtGui.QIcon.ic("document_open.png")
