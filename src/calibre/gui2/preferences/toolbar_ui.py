...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.what.setSizeAdjustPolicy(QtWidgets.QComboBox.SizeAdjustPolicy.AdjustToMinimumContentsLengthWithIcon)
        ...
        self.all_actions.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(I("forward.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(I("back.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.current_actions.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(I("arrow-up.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(I("arrow-down.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(20, 224, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
