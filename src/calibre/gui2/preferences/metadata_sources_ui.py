...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.stack = QtWidgets.QStackedWidget(parent=Form)
        ...
        self.sources_view = QtWidgets.QTableView(parent=self.groupBox)
        self.sources_view.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.SingleSelection)
        self.sources_view.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        ...
        self.configure_plugin_button = QtWidgets.QPushButton(parent=self.groupBox)
        icon = QtGui.QIcon.ic("plugins.png")
        ...
        self.fields_view = QtWidgets.QListView(parent=self.groupBox_2)
        ...
        self.fields_view.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        self.fields_view.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.NoSelection)
        self.fields_view.setFlow(QtWidgets.QListView.Flow.LeftToRight)
        self.fields_view.setProperty("isWrapping", True)
        self.fields_view.setResizeMode(QtWidgets.QListView.ResizeMode.Adjust)
        self.fields_view.setObjectName("fields_view")
        self.gridLayout_2.addWidget(self.fields_view, 0, 0, 1, 2)
        self.select_all_button = QtWidgets.QPushButton(parent=self.groupBox_2)
        self.select_all_button.setObjectName("select_all_button")
        self.gridLayout_2.addWidget(self.select_all_button, 1, 0, 1, 1)
        self.clear_all_button = QtWidgets.QPushButton(parent=self.groupBox_2)
        self.clear_all_button.setObjectName("clear_all_button")
        self.gridLayout_2.addWidget(self.clear_all_button, 1, 1, 1, 1)
        self.select_default_button = QtWidgets.QPushButton(parent=self.groupBox_2)
        ...
        self.set_as_default_button = QtWidgets.QPushButton(parent=self.groupBox_2)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 350, 441))
        ...
        self.opt_txt_comments = QtWidgets.QCheckBox(parent=self.scrollAreaWidgetContents)
        self.opt_txt_comments.setObjectName("opt_txt_comments")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_txt_comments)
        self.opt_swap_author_names = QtWidgets.QCheckBox(parent=self.scrollAreaWidgetContents)
        self.opt_swap_author_names.setObjectName("opt_swap_author_names")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_swap_author_names)
        self.opt_append_comments = QtWidgets.QCheckBox(parent=self.scrollAreaWidgetContents)
        self.opt_append_comments.setObjectName("opt_append_comments")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_append_comments)
        self.opt_keep_dups = QtWidgets.QCheckBox(parent=self.scrollAreaWidgetContents)
        self.opt_keep_dups.setObjectName("opt_keep_dups")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_keep_dups)
        self.opt_fewer_tags = QtWidgets.QCheckBox(parent=self.scrollAreaWidgetContents)
        self.opt_fewer_tags.setObjectName("opt_fewer_tags")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_fewer_tags)
        self.map_rules_button = QtWidgets.QToolButton(parent=self.scrollAreaWidgetContents)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.map_rules_button.sizePolicy().hasHeightForWidth())
        self.map_rules_button.setSizePolicy(sizePolicy)
        self.map_rules_button.setPopupMode(QtWidgets.QToolButton.ToolButtonPopupMode.InstantPopup)
        self.map_rules_button.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextOnly)
        self.map_rules_button.setObjectName("map_rules_button")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.map_rules_button)
        ...
        self.opt_max_tags = QtWidgets.QSpinBox(parent=self.scrollAreaWidgetContents)
        self.opt_max_tags.setObjectName("opt_max_tags")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_max_tags)
        ...
        self.opt_wait_after_first_identify_result = QtWidgets.QSpinBox(parent=self.scrollAreaWidgetContents)
        self.opt_wait_after_first_identify_result.setObjectName("opt_wait_after_first_identify_result")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_wait_after_first_identify_result)
        ...
        self.opt_wait_after_first_cover_result = QtWidgets.QSpinBox(parent=self.scrollAreaWidgetContents)
        self.opt_wait_after_first_cover_result.setObjectName("opt_wait_after_first_cover_result")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_wait_after_first_cover_result)
...
"<p>Note that this option will only make a practical difference if one of the metadata sources has a genre like tag set for the book you are searching for. Most often, they all have large tag sets."))
        ...
        self.map_rules_button.setText(_("Create &rules to transform tags/authors/publishers"))
