...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.opt_wait_after_first_cover_result, 10, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.opt_max_tags, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.opt_wait_after_first_identify_result, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.groupBox, 0, 0, 11, 1)
        ...
        self.author_map_rules_button = QtWidgets.QPushButton(self.page)
        self.author_map_rules_button.setObjectName("author_map_rules_button")
        self.gridLayout.addWidget(self.author_map_rules_button, 7, 1, 1, 2)
