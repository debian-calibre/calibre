...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.opt_numeric_collation)
        ...
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.SpanningRole, self.opt_delete_news_from_library_on_upload)
