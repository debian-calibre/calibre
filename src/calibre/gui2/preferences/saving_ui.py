...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.opt_timefmt = QtWidgets.QLineEdit(parent=Form)
        ...
        self.opt_write_opf = QtWidgets.QCheckBox(parent=Form)
        self.opt_write_opf.setObjectName("opt_write_opf")
        self.gridLayout.addWidget(self.opt_write_opf, 3, 0, 1, 1)
        self.opt_save_extra_files = QtWidgets.QCheckBox(parent=Form)
        self.opt_save_extra_files.setObjectName("opt_save_extra_files")
        self.gridLayout.addWidget(self.opt_save_extra_files, 5, 0, 1, 1)
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setWordWrap(True)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 0, 0, 1, 2)
        self.opt_to_lowercase = QtWidgets.QCheckBox(parent=Form)
        self.opt_to_lowercase.setObjectName("opt_to_lowercase")
        self.gridLayout.addWidget(self.opt_to_lowercase, 2, 1, 1, 1)
        self.opt_replace_whitespace = QtWidgets.QCheckBox(parent=Form)
    ...
    def retranslateUi(self, Form):
        ...
        self.opt_save_extra_files.setText(_("Save &data files as well"))
