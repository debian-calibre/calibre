...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_20 = QtWidgets.QLabel(self.main_interface_tab)
        ...
        spacerItem10 = QtWidgets.QSpacerItem(690, 20, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.label_20.setBuddy(self.opt_color_palette)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_20.setText(_("Color &palette (needs restart):"))
        self.opt_color_palette.setToolTip(_("The colors to use for the calibre interface. By default the system colors are used. You can change this to force a light or dark color scheme. Note that if this is not set to system default then if the system wide color scheme is changed calibre will not follow it."))
