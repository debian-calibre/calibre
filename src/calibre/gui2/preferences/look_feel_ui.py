...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tabWidget = ScrollingTabWidget(parent=Form)
        ...
        self.opt_show_layout_buttons = QtWidgets.QCheckBox(parent=self.main_interface_tab)
        ...
        self.opt_language = QtWidgets.QComboBox(parent=self.main_interface_tab)
        ...
        self.opt_gui_layout = QtWidgets.QComboBox(parent=self.main_interface_tab)
        ...
        self.opt_book_list_extra_row_spacing = QtWidgets.QSpinBox(parent=self.main_interface_tab)
        ...
        self.opt_ui_style = QtWidgets.QComboBox(parent=self.main_interface_tab)
        self.opt_ui_style.setObjectName("opt_ui_style")
        self.gridLayout_9.addWidget(self.opt_ui_style, 0, 1, 1, 1)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.label_2 = QtWidgets.QLabel(parent=self.main_interface_tab)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout.addWidget(self.label_2)
        self.font_display = QtWidgets.QLineEdit(parent=self.main_interface_tab)
        ...
        self.label_17 = QtWidgets.QLabel(parent=self.main_interface_tab)
        self.label_17.setObjectName("label_17")
        self.gridLayout_9.addWidget(self.label_17, 3, 0, 1, 1)
        self.opt_booklist_grid = QtWidgets.QCheckBox(parent=self.main_interface_tab)
        self.opt_booklist_grid.setObjectName("opt_booklist_grid")
        self.gridLayout_9.addWidget(self.opt_booklist_grid, 12, 0, 1, 2)
        self.label_widget_style = QtWidgets.QLabel(parent=self.main_interface_tab)
        ...
        self.opt_disable_animations = QtWidgets.QCheckBox(parent=self.main_interface_tab)
        ...
        self.opt_dnd_merge = QtWidgets.QCheckBox(parent=self.main_interface_tab)
        self.opt_dnd_merge.setObjectName("opt_dnd_merge")
        self.gridLayout_9.addWidget(self.opt_dnd_merge, 13, 0, 1, 1)
        self.opt_row_numbers_in_book_list = QtWidgets.QCheckBox(parent=self.main_interface_tab)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=self.main_interface_tab)
        self.groupBox_2.setObjectName("groupBox_2")
        self.gridLayout_8 = QtWidgets.QGridLayout(self.groupBox_2)
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.opt_toolbar_icon_size = QtWidgets.QComboBox(parent=self.groupBox_2)
        ...
        self.opt_toolbar_text = QtWidgets.QComboBox(parent=self.groupBox_2)
        ...
        self.opt_wrap_toolbar_text = QtWidgets.QCheckBox(parent=self.groupBox_2)
        ...
        self.opt_disable_tray_notification = QtWidgets.QCheckBox(parent=self.main_interface_tab)
        ...
        self.label_7 = QtWidgets.QLabel(parent=self.main_interface_tab)
        self.label_7.setObjectName("label_7")
        self.gridLayout_9.addWidget(self.label_7, 4, 0, 1, 1)
        self.opt_book_list_tooltips = QtWidgets.QCheckBox(parent=self.main_interface_tab)
        ...
        self.opt_color_palette_label = QtWidgets.QLabel(parent=self.main_interface_tab)
        ...
        self.opt_color_palette = QtWidgets.QComboBox(parent=self.main_interface_tab)
        ...
        self.opt_field_under_covers_in_grid = QtWidgets.QComboBox(parent=self.tab_5)
        ...
        self.opt_cover_grid_spacing = QtWidgets.QDoubleSpinBox(parent=self.tab_5)
        ...
        self.cg_background_box = QtWidgets.QGroupBox(parent=self.tab_5)
        ...
        self.cover_size_label = QtWidgets.QLabel(parent=self.groupBox_4)
        ...
        self.cover_grid_aspect_ratio = QtWidgets.QLabel(parent=self.groupBox_4)
        ...
        self.opt_cover_grid_width = QtWidgets.QDoubleSpinBox(parent=self.groupBox_4)
        ...
        self.cover_grid_larger_cover = QtWidgets.QPushButton(parent=self.groupBox_4)
        ...
        self.opt_cover_grid_height = QtWidgets.QDoubleSpinBox(parent=self.groupBox_4)
        ...
        self.cover_grid_smaller_cover = QtWidgets.QPushButton(parent=self.groupBox_4)
        ...
        self.cover_grid_reset_size = QtWidgets.QPushButton(parent=self.groupBox_4)
        ...
        self.opt_emblem_size = QtWidgets.QSpinBox(parent=self.tab_5)
        ...
        self.opt_cover_grid_show_title = QtWidgets.QCheckBox(parent=self.tab_5)
        ...
        self.opt_emblem_position = QtWidgets.QComboBox(parent=self.tab_5)
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(parent=self.tab_6)
        ...
        self.opt_cover_grid_disk_cache_size = QtWidgets.QSpinBox(parent=self.groupBox_3)
        ...
        self.cover_grid_empty_cache = QtWidgets.QPushButton(parent=self.groupBox_3)
        ...
        self.cover_grid_open_cache = QtWidgets.QPushButton(parent=self.groupBox_3)
        ...
        self.opt_cover_grid_cache_size_multiple = QtWidgets.QSpinBox(parent=self.groupBox_3)
        ...
        self.cover_grid_current_disk_cache = QtWidgets.QLabel(parent=self.groupBox_3)
        ...
        self.groupBox_5 = QtWidgets.QGroupBox(parent=self.book_details_tab)
        self.groupBox_5.setObjectName("groupBox_5")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.groupBox_5)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.opt_book_details_css = QtWidgets.QPlainTextEdit(parent=self.groupBox_5)
        ...
        self.id_links_button = QtWidgets.QPushButton(parent=self.book_details_tab)
        self.id_links_button.setObjectName("id_links_button")
        self.gridLayout_6.addWidget(self.id_links_button, 5, 0, 1, 3)
        self.default_author_link_container = QtWidgets.QWidget(parent=self.book_details_tab)
        ...
        self.groupBox3 = QtWidgets.QGroupBox(parent=self.book_details_tab)
        ...
        self.bd_vertical_cats = QtWidgets.QListView(parent=self.groupBox3)
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=self.book_details_tab)
        self.groupBox.setObjectName("groupBox")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.groupBox)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.df_down_button = QtWidgets.QToolButton(parent=self.groupBox)
        ...
        self.df_up_button = QtWidgets.QToolButton(parent=self.groupBox)
        ...
        self.field_display_order = ListViewWithMoveByKeyPress(parent=self.groupBox)
        ...
        self.opt_bd_show_cover = QtWidgets.QCheckBox(parent=self.book_details_tab)
        self.opt_bd_show_cover.setObjectName("opt_bd_show_cover")
        self.hboxlayout.addWidget(self.opt_bd_show_cover)
        self.opt_bd_overlay_cover_size = QtWidgets.QCheckBox(parent=self.book_details_tab)
        ...
        self.opt_use_roman_numerals_for_series_number = QtWidgets.QCheckBox(parent=self.book_details_tab)
        ...
        self.label_25 = QtWidgets.QLabel(parent=self.book_details_tab)
        self.label_25.setObjectName("label_25")
        self.horizontalLayout_2.addWidget(self.label_25)
        self.opt_book_details_comments_heading_pos = QtWidgets.QComboBox(parent=self.book_details_tab)
        ...
        self.edit_metadata_single_label = QtWidgets.QLabel(parent=self.edit_metadata_tab)
        ...
        self.opt_edit_metadata_single_layout = QtWidgets.QComboBox(parent=self.edit_metadata_tab)
        ...
        self.groupBox1 = QtWidgets.QGroupBox(parent=self.edit_metadata_tab)
        self.groupBox1.setObjectName("groupBox1")
        self.gridLayout_31 = QtWidgets.QGridLayout(self.groupBox1)
        self.gridLayout_31.setObjectName("gridLayout_31")
        self.em_down_button = QtWidgets.QToolButton(parent=self.groupBox1)
        ...
        self.em_up_button = QtWidgets.QToolButton(parent=self.groupBox1)
        ...
        self.em_display_order = ListViewWithMoveByKeyPress(parent=self.groupBox1)
        ...
        self.em_reset_layout_button = QtWidgets.QPushButton(parent=self.groupBox1)
        ...
        self.em_import_layout_button = QtWidgets.QPushButton(parent=self.groupBox1)
        ...
        self.em_export_layout_button = QtWidgets.QPushButton(parent=self.groupBox1)
        ...
        self.opt_edit_metadata_ignore_display_order = QtWidgets.QCheckBox(parent=self.edit_metadata_tab)
        ...
        self.opt_edit_metadata_elide_labels = QtWidgets.QCheckBox(parent=self.edit_metadata_tab)
        ...
        self.label_1023 = QtWidgets.QLabel(parent=self.edit_metadata_tab)
        ...
        self.label_102 = QtWidgets.QLabel(parent=self.edit_metadata_tab)
        self.label_102.setObjectName("label_102")
        self.hboxlayout2.addWidget(self.label_102)
        self.opt_edit_metadata_elision_point = QtWidgets.QComboBox(parent=self.edit_metadata_tab)
        ...
        self.opt_edit_metadata_templates_only_F2_on_booklist = QtWidgets.QCheckBox(parent=self.edit_metadata_tab)
        ...
        self.opt_edit_metadata_single_use_2_cols_for_custom_fields = QtWidgets.QCheckBox(parent=self.edit_metadata_tab)
        ...
        self.label_1021 = QtWidgets.QLabel(parent=self.edit_metadata_tab)
        ...
        self.opt_edit_metadata_bulk_cc_label_length = QtWidgets.QSpinBox(parent=self.edit_metadata_tab)
        ...
        self.label_1022 = QtWidgets.QLabel(parent=self.edit_metadata_tab)
        ...
        self.opt_edit_metadata_single_cc_label_length = QtWidgets.QSpinBox(parent=self.edit_metadata_tab)
        ...
        self.label = QtWidgets.QLabel(parent=self.tb_tab1)
        self.label.setObjectName("label")
        self.verticalLayout_42.addWidget(self.label, 0, 0, 1, 1)
        self.tb_display_order = ListViewWithMoveByKeyPress(parent=self.tb_tab1)
        ...
        self.tb_up_button = QtWidgets.QToolButton(parent=self.tb_tab1)
        ...
        self.tb_down_button = QtWidgets.QToolButton(parent=self.tb_tab1)
        ...
        self.tb_reset_layout_button = QtWidgets.QPushButton(parent=self.tb_tab1)
        ...
        self.tb_import_layout_button = QtWidgets.QPushButton(parent=self.tb_tab1)
        ...
        self.tb_export_layout_button = QtWidgets.QPushButton(parent=self.tb_tab1)
        ...
        self.opt_show_avg_rating = QtWidgets.QCheckBox(parent=self.tb_tab1)
        ...
        self.opt_tag_browser_show_tooltips = QtWidgets.QCheckBox(parent=self.tb_tab1)
        ...
        self.opt_tag_browser_show_counts = QtWidgets.QCheckBox(parent=self.tb_tab1)
        ...
        self.opt_tag_browser_old_look = QtWidgets.QCheckBox(parent=self.tb_tab1)
        ...
        self.opt_tag_browser_hide_empty_categories = QtWidgets.QCheckBox(parent=self.tb_tab1)
        ...
        self.opt_tag_browser_always_autocollapse = QtWidgets.QCheckBox(parent=self.tb_tab1)
        ...
        self.opt_tag_browser_allow_keyboard_focus = QtWidgets.QCheckBox(parent=self.tb_tab1)
        ...
        self.tb_focus_label = QtWidgets.QLabel(parent=self.tb_tab1)
        ...
        self.formLayout.setObjectName("formLayout")
        self.label1 = QtWidgets.QLabel(parent=self.tb_tab1)
        self.label1.setObjectName("label1")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label1)
        self.opt_tag_browser_item_padding = QtWidgets.QDoubleSpinBox(parent=self.tb_tab1)
        ...
        self.formLayout1.setObjectName("formLayout1")
        self.label_9 = QtWidgets.QLabel(parent=self.tb_tab2)
        self.label_9.setObjectName("label_9")
        self.formLayout1.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_9)
        self.opt_tags_browser_partition_method = QtWidgets.QComboBox(parent=self.tb_tab2)
        ...
        self.label_10 = QtWidgets.QLabel(parent=self.tb_tab2)
        self.label_10.setObjectName("label_10")
        self.formLayout1.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_10)
        self.opt_tags_browser_collapse_fl_at = QtWidgets.QSpinBox(parent=self.tb_tab2)
        ...
        self.label_101 = QtWidgets.QLabel(parent=self.tb_tab2)
        self.label_101.setObjectName("label_101")
        self.formLayout1.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_101)
        self.opt_tags_browser_collapse_at = QtWidgets.QSpinBox(parent=self.tb_tab2)
        ...
        self.label2 = QtWidgets.QLabel(parent=self.tb_tab2)
        self.label2.setObjectName("label2")
        self.gridLayout_10.addWidget(self.label2, 1, 0, 1, 1)
        self.tb_cats_to_partition = QtWidgets.QListView(parent=self.tb_tab2)
        ...
        self.horizontalLayout_41 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_41.setObjectName("horizontalLayout_41")
        self.tb_partition_reset_button = QtWidgets.QPushButton(parent=self.tb_tab2)
        ...
        self.tb_partition_import_layout_button = QtWidgets.QPushButton(parent=self.tb_tab2)
        ...
        self.tb_partition_export_layout_button = QtWidgets.QPushButton(parent=self.tb_tab2)
        ...
        self.gridlayout.setObjectName("gridlayout")
        self.label3 = QtWidgets.QLabel(parent=self.tb_tab3)
        self.label3.setObjectName("label3")
        self.gridlayout.addWidget(self.label3, 0, 0, 1, 1)
        self.tb_hierarchical_cats = QtWidgets.QListView(parent=self.tb_tab3)
        ...
        self.tb_hierarchy_reset_layout_button = QtWidgets.QPushButton(parent=self.tb_tab3)
        ...
        self.tb_hierarchy_import_layout_button = QtWidgets.QPushButton(parent=self.tb_tab3)
        ...
        self.tb_hierarchy_export_layout_button = QtWidgets.QPushButton(parent=self.tb_tab3)
        ...
        self.label4 = QtWidgets.QLabel(parent=self.tb_tab3)
        self.label4.setObjectName("label4")
        self.gridlayout.addWidget(self.label4, 11, 0, 1, 1)
        self.tb_search_order = ListWidgetWithMoveByKeyPress(parent=self.tb_tab3)
        ...
        self.tb_search_order_up_button = QtWidgets.QToolButton(parent=self.tb_tab3)
        ...
        self.tb_search_order_down_button = QtWidgets.QToolButton(parent=self.tb_tab3)
        ...
        self.tb_search_order_reset_button = QtWidgets.QPushButton(parent=self.tb_tab3)
        ...
        self.opt_cb_fullscreen = QtWidgets.QCheckBox(parent=self.cover_browser_tab)
        self.opt_cb_fullscreen.setObjectName("opt_cb_fullscreen")
        self.gridLayout_11.addWidget(self.opt_cb_fullscreen, 1, 0, 1, 1)
        self.opt_separate_cover_flow = QtWidgets.QCheckBox(parent=self.cover_browser_tab)
        ...
        self.opt_cover_flow_queue_length = QtWidgets.QSpinBox(parent=self.cover_browser_tab)
        ...
        self.label_6 = QtWidgets.QLabel(parent=self.cover_browser_tab)
        self.label_6.setObjectName("label_6")
        self.gridLayout_11.addWidget(self.label_6, 3, 0, 1, 1)
        self.cover_browser_title_template_button = QtWidgets.QPushButton(parent=self.cover_browser_tab)
        ...
        self.opt_cover_browser_title_template = QtWidgets.QLineEdit(parent=self.cover_browser_tab)
        ...
        self.opt_cover_browser_reflections = QtWidgets.QCheckBox(parent=self.cover_browser_tab)
        ...
        self.opt_cb_preserve_aspect_ratio = QtWidgets.QCheckBox(parent=self.cover_browser_tab)
        ...
        self.opt_cover_browser_subtitle_field = QtWidgets.QComboBox(parent=self.cover_browser_tab)
        ...
        self.label_23 = QtWidgets.QLabel(parent=self.cover_browser_tab)
        self.label_23.setObjectName("label_23")
        self.gridLayout_11.addWidget(self.label_23, 7, 0, 1, 1)
        self.label_24 = QtWidgets.QLabel(parent=self.cover_browser_tab)
        self.label_24.setObjectName("label_24")
        self.gridLayout_11.addWidget(self.label_24, 8, 0, 1, 1)
        self.fs_help_msg = QtWidgets.QLabel(parent=self.cover_browser_tab)
        ...
        self.label_26 = QtWidgets.QLabel(parent=self.cover_browser_tab)
        self.label_26.setObjectName("label_26")
        self.gridLayout_11.addWidget(self.label_26, 9, 0, 1, 1)
        self.opt_books_autoscroll_time = QtWidgets.QDoubleSpinBox(parent=self.cover_browser_tab)
        ...
        self.opt_cb_double_click_to_activate = QtWidgets.QCheckBox(parent=self.cover_browser_tab)
        ...
        self.opt_qv_respects_vls = QtWidgets.QCheckBox(parent=self.quickview_tab)
        ...
        self.opt_qv_follows_column = QtWidgets.QCheckBox(parent=self.quickview_tab)
        ...
        self.opt_qv_retkey_changes_column = QtWidgets.QCheckBox(parent=self.quickview_tab)
        ...
        self.opt_qv_dclick_changes_column = QtWidgets.QCheckBox(parent=self.quickview_tab)
        ...
        self.groupBox2 = QtWidgets.QGroupBox(parent=self.quickview_tab)
        self.groupBox2.setObjectName("groupBox2")
        self.gridLayout_32 = QtWidgets.QGridLayout(self.groupBox2)
        self.gridLayout_32.setObjectName("gridLayout_32")
        self.qv_up_button = QtWidgets.QToolButton(parent=self.groupBox2)
        ...
        self.qv_down_button = QtWidgets.QToolButton(parent=self.groupBox2)
        ...
        self.qv_display_order = ListViewWithMoveByKeyPress(parent=self.groupBox2)
        ...
        self.sections_view = QtWidgets.QListWidget(parent=Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
