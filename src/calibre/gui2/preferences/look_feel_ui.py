...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout_3.addWidget(self.sections_view)
        ...
        self.formlayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.edit_metadata_single_label)
        ...
        self.formlayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.opt_edit_metadata_single_layout)
        ...
        self.em_display_order = QtWidgets.QListView(self.groupBox1)
        ...
        self.formlayout1.setWidget(0, QtWidgets.QFormLayout.SpanningRole, self.opt_edit_metadata_ignore_display_order)
        ...
        self.formlayout2.setWidget(0, QtWidgets.QFormLayout.SpanningRole, self.opt_edit_metadata_single_use_2_cols_for_custom_fields)
        self.label_1021 = QtWidgets.QLabel(self.edit_metadata_tab)
        self.label_1021.setObjectName("label_1021")
        self.formlayout2.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_1021)
        ...
        self.formlayout2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.opt_edit_metadata_bulk_cc_label_length)
        self.label_1022 = QtWidgets.QLabel(self.edit_metadata_tab)
        self.label_1022.setObjectName("label_1022")
        self.formlayout2.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_1022)
        ...
        self.formlayout2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.opt_edit_metadata_single_cc_label_length)
        self.hboxlayout1.addLayout(self.formlayout2)
        self.vbox_layout_61.addLayout(self.hboxlayout1)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(I("edit_input.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(I("tags.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        spacerItem9 = QtWidgets.QSpacerItem(690, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_11.addItem(spacerItem9, 11, 0, 1, 2)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(I("cover_flow.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.qv_display_order = QtWidgets.QListView(self.groupBox2)
        ...
        self.gridLayout_32.addItem(spacerItem10, 1, 1, 1, 1)
        self.gridLayout_122.addWidget(self.groupBox2, 3, 0, 2, 1)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(I("quickview.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Form):
        ...
        self.opt_disable_tray_notification.setToolTip(_("Disable popup notifications when calibre completes jobs such as conversion of books, sending to device, etc. The notifications are sent via the operating system notification facility, if available."))
...
"when the column in the book list is changed using the cursor arrow keys"))
        ...
        self.opt_qv_retkey_changes_column.setToolTip(_("Pressing Enter in a cell changes both the book and the\n"
