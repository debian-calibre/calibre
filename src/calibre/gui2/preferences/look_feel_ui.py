...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cover_grid_tab.setTabPosition(QtWidgets.QTabWidget.TabPosition.West)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(I("minus.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(I("grid.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(I("arrow-up.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(I("book.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_tags_browser_partition_method)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_tags_browser_collapse_at)
        self.label_101 = QtWidgets.QLabel(self.tag_browser_tab)
        self.label_101.setObjectName("label_101")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_101)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_tags_browser_collapse_fl_at)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_tag_browser_item_padding)
        self.label_8111 = QtWidgets.QLabel(self.tag_browser_tab)
        self.label_8111.setObjectName("label_8111")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_8111)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_tag_browser_dont_collapse)
        self.label_81 = QtWidgets.QLabel(self.tag_browser_tab)
        self.label_81.setObjectName("label_81")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_81)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.opt_categories_using_hierarchy)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.ItemRole.LabelRole, self.opt_tag_browser_show_tooltips)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.ItemRole.LabelRole, self.opt_show_avg_rating)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_tag_browser_show_counts)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_tag_browser_old_look)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_tag_browser_hide_empty_categories)
        ...
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_tag_browser_always_autocollapse)
        ...
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.opt_tag_browser_allow_keyboard_focus)
        ...
        self.formLayout.setWidget(15, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.tb_focus_label)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(I("tags.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        spacerItem8 = QtWidgets.QSpacerItem(690, 283, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(I("cover_flow.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(I("quickview.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
