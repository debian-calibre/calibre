...
var str = ρσ_str, repr = ρσ_repr;;
    ...
    (function(){
        ...
        function go_to_line(lnum, sync_context) {
            var node;
            var ρσ_Iter2 = ρσ_Iterable(document.querySelectorAll("[data-lnum=\"" + ρσ_str.format("{}", lnum) + "\"]"));
            for (var ρσ_Index2 = 0; ρσ_Index2 < ρσ_Iter2.length; ρσ_Index2++) {
        ...
        function line_numbers() {
            ...
            found_body = false;
            ans = [];
            var ρσ_Iter4 = ρσ_Iterable(document.getElementsByTagName("*"));
        ...
        function find_blocks() {
            ...
            var ρσ_Iter5 = ρσ_Iterable(document.body.getElementsByTagName("*"));
        ...
        var live_css = from_python((function() {
            var ρσ_anonfunc = function live_css(editor_name, sourceline, tags) {
                ...
                target = null;
                i = 0;
                var ρσ_Iter6 = ρσ_Iterable(document.querySelectorAll("[data-lnum=\"" + ρσ_str.format("{}", sourceline) + "\"]"));
        ...
        function check_for_maths() {
            ...
            var ρσ_Iter7 = ρσ_Iterable(document.scripts);
            for (var ρσ_Index7 = 0; ρσ_Index7 < ρσ_Iter7.length; ρσ_Index7++) {
                s = ρσ_Iter7[ρσ_Index7];
